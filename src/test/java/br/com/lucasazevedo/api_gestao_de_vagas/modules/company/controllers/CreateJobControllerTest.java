...
import br.com.lucasazevedo.api_gestao_de_vagas.Modules.Company.dto.CreateJobDTO;
...
import br.com.lucasazevedo.api_gestao_de_vagas.utils.TestUtils;
...
public class CreateJobControllerTest {
    ...
    public void should_be_able_to_create_a_new_job() throws Exception {
        ...
        var result = mvc.perform(MockMvcRequestBuilders.post("/company/job/")
                ...
                .header("Authorization", TestUtils.generateToken(company.getId(), "tokensecretosegredo"))
        )
